...
buy at $open WHEN $macdhist_12_26_9 becomes positive;
...
TODO: {
    ...
    my $coderef = sub {
        ...
        my $idx_1 =
        which($macdhist_12_26_9 >= 1e-06 &&
            $macdhist_12_26_9->index($idx_0) < 1e-06 );
        note($idx_1->dims);
        #$buys->index($idx_1) .= $open->index($idx_1);
        return {
            buys  => $buys,
            sells => $sells
        };
